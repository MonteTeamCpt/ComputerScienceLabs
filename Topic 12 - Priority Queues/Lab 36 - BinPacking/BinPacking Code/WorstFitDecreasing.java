...
public class WorstFitDecreasing
{
	...
	/**
	 * Grabs a queue of numbers and adds them all in decreasing order from 
	 * largest to greatest into the Main Queue
	 * @param all -  a Queue of integers from runner
	 */
	public void setAll(Queue<Integer> all)
	{
